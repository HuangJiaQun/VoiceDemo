...
#define IOS7_OR_LATER   ( [[[UIDevice currentDevice] systemVersion] compare:@"7.0" options:NSNumericSearch] != NSOrderedAscending )//a > b
#define ButtonHeight 44
#define NavigationBarHeight 44

#define APPID_VALUE  @"5df8bd56"   // 5df8bd56     //科大讯飞AppID

//#define APPID_VALUE @"56a6ea65" //科大讯飞AppID

#define URL_VALUE             @""                 // url
#define TIMEOUT_VALUE         @"20000"            // timeout, Unit:ms,//连接超时的时间，以ms为单位
